...
impl Animation for JumpAnimation {
    ...
    fn update_skeleton(
        ...
        next.belt.offset = Vec3::new(0.0, 0.0, 6.0) * skeleton_attr.scaler;
        next.belt.ori = Quaternion::rotation_z(0.0);
        next.belt.scale = Vec3::one() * skeleton_attr.scaler;

        next.shorts.offset = Vec3::new(0.0, 0.0, 3.0) * skeleton_attr.scaler;
        ...
        next.l_foot.offset = Vec3::new(-3.4, 1.0, 6.0) * skeleton_attr.scaler;
        next.l_foot.ori = Quaternion::rotation_x(wave_stop * -1.2 - wave_slow * 0.2);
        next.l_foot.scale = Vec3::one() * skeleton_attr.scaler;

        next.r_foot.offset = Vec3::new(3.4, -1.0, 6.0) * skeleton_attr.scaler;
