...
impl<X: LodConfig> LodData<X>
{
    ...
    pub fn set15(&mut self, index: LodIndex, value: X::L15) { let n = self.int_get_n(index,15).index; self.layer15[n] = value }
    ...
    */
    fn int_make_at_least(&mut self, parent: AbsIndex, /*parent_lod2: LodIndex,*/ area: LodArea, target_layer: u8) {
                ...
                for x in lower_xyz[0]..upper_xyz[0]+1 {
                    for y in lower_xyz[1]..upper_xyz[1]+1 {
                        for z in lower_xyz[2]..upper_xyz[2]+1 {
                            ...
                            Self::int_make_at_least(self, child_abs, inner_area, target_layer);
                        }
                    }
                }
            }
    ...
    */
    ...
    pub fn make_at_least(&mut self, area: LodArea, target_layer: u8) {
            ...
            while y <= upper_xyz[1] {
                ...
                while z <= upper_xyz[2] {
                    ...
                    if anchor_abs.layer > target_layer {
                        ...
                        let inner_area = LodArea::new(inner_lower, inner_upper);
                        self.int_make_at_least(anchor_abs, inner_area, target_layer);
                    }
                    z += anchor_width;
                }
                y += anchor_width;
